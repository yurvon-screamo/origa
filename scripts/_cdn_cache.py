...
_RELEASE_UPDATED_RULES: Final[frozenset[str]] = frozenset(
    {
        # Counter-word registry (issue #415): regenerated from
        # scripts/data/counters/ on content changes — release-updated,
        # never immutable.
        "counters/",
        "dictionary/",
        "grammar/",
        ...
        # #535: the deduplicated + deflated v3 form of the same index —
        # listed explicitly so a future default-policy change cannot
        # silently re-tier it.
