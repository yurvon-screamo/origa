...
/// - Секции с примерами использования слов (ExamplesSection)
/// - Информация о радикалах кандзи (KanjiInfoSection)
/// - Списки радикалов (RadicalsSection)
/// - Панели связанных карточек (SimilarityPanel, HomonymsPanel)
/// - Любые другие информационные блоки, требующие визуального выделения
///
/// ## Цветовые темы:
