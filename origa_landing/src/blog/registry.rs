...
const ARTICLES: &[(Locale, &str, &str)] = &[
    ...
    // Article 14: "JLPT N5 Kanji List (+PDF)" — all 4 locales under one slug.
    // The kanji table inside each file is generated by scripts/build_jlpt_pdf.py
    // (block markers jlpt-kanji-table:N5:begin/end) from the same data as the
    // PDFs — do not hand-edit the table; edit cdn/dictionary/kanji.json and
    // re-run the script.
    (
        Locale::En,
        "jlpt-n5-kanji-list",
        include_str!("../../content/blog/en/jlpt-n5-kanji-list.md"),
    ),
    (
        Locale::Ru,
        "jlpt-n5-kanji-list",
        include_str!("../../content/blog/ru/jlpt-n5-kanji-list.md"),
    ),
    (
        Locale::Ko,
        "jlpt-n5-kanji-list",
        include_str!("../../content/blog/ko/jlpt-n5-kanji-list.md"),
    ),
    (
        Locale::Vi,
        "jlpt-n5-kanji-list",
        include_str!("../../content/blog/vi/jlpt-n5-kanji-list.md"),
    ),
    // Article 15: "Is Kanji Hard to Learn" — all 4 locales under one slug.
    (
        Locale::En,
        "is-kanji-hard-to-learn",
        include_str!("../../content/blog/en/is-kanji-hard-to-learn.md"),
    ),
    (
        Locale::Ru,
        "is-kanji-hard-to-learn",
        include_str!("../../content/blog/ru/is-kanji-hard-to-learn.md"),
    ),
    (
        Locale::Ko,
        "is-kanji-hard-to-learn",
        include_str!("../../content/blog/ko/is-kanji-hard-to-learn.md"),
    ),
    (
        Locale::Vi,
        "is-kanji-hard-to-learn",
        include_str!("../../content/blog/vi/is-kanji-hard-to-learn.md"),
    ),
    // Article 16: "How to Learn Japanese by Yourself" — all 4 locales.
    (
        Locale::En,
        "how-to-learn-japanese-by-yourself",
        include_str!("../../content/blog/en/how-to-learn-japanese-by-yourself.md"),
    ),
    (
        Locale::Ru,
        "how-to-learn-japanese-by-yourself",
        include_str!("../../content/blog/ru/how-to-learn-japanese-by-yourself.md"),
    ),
    (
        Locale::Ko,
        "how-to-learn-japanese-by-yourself",
        include_str!("../../content/blog/ko/how-to-learn-japanese-by-yourself.md"),
    ),
    (
        Locale::Vi,
        "how-to-learn-japanese-by-yourself",
        include_str!("../../content/blog/vi/how-to-learn-japanese-by-yourself.md"),
    ),
];
