...
pub struct Content {
    ...
    // Per-slide copy shown beside the screens carousel and synced to the
    // active slide by the inline script: (title, description) × 5 slides.
    pub home_shots: &'static [(&'static str, &'static str)],
