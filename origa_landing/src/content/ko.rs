...
pub static CONTENT: Content = Content {
    ...
    home_faq_wanikani_answer: "직접적으로는 아닙니다 — 실시간 연동은 없습니다. 작동하는 다리는 내보내기입니다: WaniKani 진행 상황을 Anki 덱으로 만들어 Origa로 가져오세요. 많은 학습자는 WaniKani를 고정된 한자 순서용으로 유지하고, Origa는 실제로 읽는 것에서 캔 어휘용으로 씁니다.",
    home_faq_kanji_start_question: "한자는 어디서 시작하나요?",
    home_faq_kanji_start_answer: "N5 세트부터, 실제 사용 빈도 순으로, 그리고 홀로 된 기호가 아니라 항상 단어 안에서입니다. 블로그에 N5 한자 전체 표와 모든 JLPT 레벨의 인쇄용 PDF 목록이 있습니다.",
