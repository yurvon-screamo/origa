...
pub static CONTENT: Content = Content {
    ...
    home_stats_line: "200,000+ native phrases with audio · N5–N1 grammar & kanji · Windows · Linux · macOS · Android · iOS · Web · Offline",
    ...
    compare_meta_description: "Looking beyond Duolingo for Japanese? Compare Origa with Anki, WaniKani, Bunpro and Duolingo across offline use, OCR capture, spaced repetition and interface languages.",
    ...
    compare_wanikani_better: "Learn kanji N5–N1 you actually encounter in your content today.",
    ...
    download_meta_description: "Download Origa free for Windows, Linux, macOS, Android, or iOS. All platforms work offline.",
