...
| Layout    | `anima-stagger`, `anima-page-fade`, `anima-slide-up`                               | Каскадное появление, переходы       |
...
| `anima-ease-out-back` | `cubic-bezier(0.34, 1.56, 0.64, 1)`     | Bounce эффекты (toast)   |
