...
use crate::components::forms::search_bar::{SearchBar, FilterChips, FilterChip};
use crate::components::forms::create_vocab_modal::{CreateVocabularyModal, CreateVocabularyData};
use crate::components::cards::vocab_card::{VocabCard, VocabularyCardData, CardStatus};
...
pub fn Vocabulary() -> impl IntoView {
    ...
    let (selected_filter, set_selected_filter) = create_signal("all".to_string());
    ...
    view! {
        <AppLayout active_tab="vocabulary".to_string()>
            ...
            <div class="section">
                ...
                // Empty state
                <Show
                    when=move || filtered_vocabulary().is_empty()
                ...
                >
                    <div class="empty-state">
                        ...
                        <p class="empty-description">
                            {move || if search_query().is_empty() && selected_filter() != "all" {
                                "В этой категории пока нет слов".to_string()
                            } else if search_query().is_empty() {
                                "Начните добавлять слова в свой словарь".to_string()
                            } else {
