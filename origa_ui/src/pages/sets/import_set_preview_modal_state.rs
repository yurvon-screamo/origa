...
use origa::application::{CreateCardsFromAnalysisUseCase, ImportWellKnownSetUseCase, WordToCreate};
...
impl ImportPreviewModalState {
    ...
    pub fn load_preview(&self, set_id: String) {
        ...
        spawn_local(async move {
            let use_case =
                ImportWellKnownSetUseCase::new(&repository, &llm_service, &well_known_loader);
...
use origa::application::CreateCardsFromAnalysisResult;
