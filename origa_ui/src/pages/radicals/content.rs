        ...
        <div class="space-y-4">
            ...
            <Show when=move || !is_loading.get()>
                ...
                <div class="flex flex-wrap gap-2">
                    <FilterBtn filter=Filter::All count=move || counts.get().total active=filter test_id="radicals-filter-all" />
                    <FilterBtn filter=Filter::New count=move || counts.get().new active=filter test_id="radicals-filter-new" />
                    <FilterBtn filter=Filter::Hard count=move || counts.get().hard active=filter test_id="radicals-filter-hard" />
                    <FilterBtn filter=Filter::InProgress count=move || counts.get().in_progress active=filter test_id="radicals-filter-in-progress" />
                    <FilterBtn filter=Filter::Learned count=move || counts.get().learned active=filter test_id="radicals-filter-learned" />
                </div>
