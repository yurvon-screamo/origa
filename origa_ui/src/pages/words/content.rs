    ...
    view! {
        <div class="space-y-4">
            ...
            <Show when=move || !is_loading.get()>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-4 items-stretch" data-testid="words-grid">
                    {move || {
                ...
                <LoadMoreButton
                    ...
                    test_id=Signal::derive(|| "words-load-more-btn".to_string())
                />
