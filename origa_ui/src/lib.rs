...
pub fn App() -> impl IntoView {
    ...
    view! {
        ...
        <Meta name="description" content="Приложение для изучения японского языка с карточками и spaced repetition" />
        <Meta name="theme-color" content="#4a6fa5" />

        // Cloud Dancer CSS styles
        <style>
            {include_str!("../styles/main.css")}
        </style>

        <ConfigProvider>
            <ServicesProvider services=AppServices::new(/* TODO: Initialize with actual use cases */)>
                <Router>
                    ...
                    <Route path=path!("/profile") view=|| view! { <div class="mobile-container">"Профиль - В разработке"</div> } />
                    </Routes>
                </Router>
            </ServicesProvider>
        </ConfigProvider>
