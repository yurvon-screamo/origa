...
#[component]
pub fn Breadcrumbs(#[prop(optional, into)] _items: Signal<Vec<BreadcrumbItem>>) -> impl IntoView {
    view! {
        <div class="breadcrumbs">
            <For
                ...
                children=move |item| {
                    ...
                    let is_last = _items.get().iter().position(|i| i.label == item.label) == Some(items_count - 1);
