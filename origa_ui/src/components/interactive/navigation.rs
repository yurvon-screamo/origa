...
pub fn StudyNavigation(
    ...
    let handle_audio_toggle = Callback::new(move |_| {
        if let Some(handler) = on_audio_toggle {
            handler.run(());
        }
    });
    ...
    view! {
        <div class="study-navigation">
            ...
            <div class="nav-center">
                <button
                    class="audio-toggle"
                    on:click=move |_| handle_audio_toggle.run(())
                    aria-label="Переключить аудио"
                >
                    <span class="audio-icon">
                        {if audio_btn_enabled { "🔊" } else { "🔇" }}
                    </span>
                ...
                <div class="setting-item">
                    <div class="setting-info">
                        ...
                        <span class="setting-description">
                            Автоматически следующая карточка
                        </span>
                    </div>
                    <div class="setting-control">
                        <label class="toggle-switch">
                            <input
                                ...
                                on:click=move |_| handle_auto_advance_toggle.run(())
                            />
                            <span class="toggle-slider"></span>
                            <span class="toggle-bg"></span>
                        </label>
                    ...
                    <div class="setting-control">
                        <label class="toggle-switch">
                            <input
                                ...
                                on:click=move |_| handle_show_answers_toggle.run(())
                            />
                            <span class="toggle-slider"></span>
                            <span class="toggle-bg"></span>
                        </label>
