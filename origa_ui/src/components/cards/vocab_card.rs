    ...
    view! {
        ...
        >
                ...
                <div class="vocab-meta">
                    <div class="vocab-progress">
                        <div class="progress-item">
                            ...
                            <div class="progress-bar difficulty" style=format!("--progress: {}%; --color: {}", card.difficulty, difficulty_color)>
                        ...
                        <div class="progress-item">
                            ...
                            <div class="progress-bar stability" style=format!("--progress: {}%; --color: {}", card.stability, stability_color)>
                                <div class="progress-fill"></div>
                            </div>
            ...
            <div class="card-actions">
                <button class="icon-button edit-btn" on:click=handle_edit aria-label="Редактировать">
                    "📝"
                </button>
                <button class="icon-button delete-btn" on:click=handle_delete aria-label="Удалить">
                    "🗑️"
                </button>
            </div>
        </BaseCard>
...
#[component]
pub function StatusBadge(status: CardStatus) -> impl IntoView {
    ...
    view! {
        <span class=format!("badge {}", color_class)>
            {label}
        </span>
    }
}
