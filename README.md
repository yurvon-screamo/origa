...
* **Импорт карточек**:
  ...
  * Обычный текст.
  * Готовые наборы.
* **Встроенный OCR**: Сфотографируйте текст — приложение распознает японские символы, приведет слова к базовой форме и автоматически найдет перевод из встроенного словаря.
* **Готовые коллекции карточек** для каждого уровня JLPT

#### 🔧 Инструменты

* **Генерация фуриганы** — автоматическое отображение чтения над кандзи. Изученные кандзи скрывают фуригану.
* **Анализ текста** — вставьте текст, чтобы узнать, какие слова и кандзи вы уже знаете, а какие новые
