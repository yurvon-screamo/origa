...
* **Алгоритм FSRS**: Современная альтернатива SM-2, адаптирующая
  график повторений под вашу память точнее, чем классические методы.
* **Гибкая настройка колод**: Создавайте свои колоды или используйте
...
* **Встроенный OCR**: Распознавание текста с изображений
  (скриншоты, фото учебников) для быстрого создания карточек.
  с уровнями японского языкового теста (N5–N1).
* **Готовые коллекции карточек** для каждого уровня JLPT

#### 🔧 Инструменты

* **Генерация фуриганы** для карточек
* **Скрытие** изученных кандзи из фуриганы
* **Дедупликация** словарных карточек
* Применение изученных **правил грамматики к словарным карточкам**
