...
- **День по UTC, а не локальный:** у юзера глубокой ночью Азии отметка
  ...
  > ⚠️ **Superseded (2026-09-20):** решение «день по UTC» отменено — граница
  > суток переведена на локальную полночь клиента (единообразно для дневных
  > лимитов, статистики и отметки «знаю»; см. ветку `fix/local-day-boundaries`).
